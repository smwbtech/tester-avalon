...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 19 2018 г., 08:38
...
(37, 8, 'What is the past form of word \"do\"?', 1, '', 1),
(38, 8, 'How you\'d translate word \"value\"?', 1, '', 2),
(39, 8, 'Which of these words are related to sport? ', 2, '', 3),
(40, 8, 'Translate this word in English: \"поезд\".', 3, '', 4);
...
(8, 'English basis test', 'This is test to check your basic knowledge in English', 9, 0, 0, 0);
...
--
ALTER TABLE `question_answer`
  MODIFY `question_answer_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `question_variant`
  MODIFY `question_variant_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=127;
--
...
--
ALTER TABLE `test`
  MODIFY `test_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
