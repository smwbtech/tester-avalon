...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 21 2018 г., 09:40
...
(1, 9, 'MTUxNjQ3NjU0ODcwOA==', 7, NULL, 16777215);
...
--
ALTER TABLE `test_answers`
  MODIFY `test_answer_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `user_answers`
--
ALTER TABLE `user_answers`
  MODIFY `user_answers_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `test_answers`
  ADD CONSTRAINT `test_answers_ibfk_1` FOREIGN KEY (`test_answer_test_id`) REFERENCES `test` (`test_id`) ON DELETE CASCADE;

--
-- Ограничения внешнего ключа таблицы `user_answers`
--
ALTER TABLE `user_answers`
  ADD CONSTRAINT `user_answers_ibfk_1` FOREIGN KEY (`user_answers_test_answers_id`) REFERENCES `test_answers` (`test_answer_id`) ON DELETE CASCADE;
