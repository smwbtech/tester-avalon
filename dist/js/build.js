...
var _reg = _interopRequireDefault(__webpack_require__(23));
  ...
  methods: {
    ...
    registration: function registration(e) {
      ...
      if (!res.success) {
        ...
        _axios.default.post('php/auth.php', this.regFormData).then(function (res) {
...
var _variables = _interopRequireDefault(__webpack_require__(9));
...
var _auth = _interopRequireDefault(__webpack_require__(18));

var _auth2 = _interopRequireDefault(__webpack_require__(19));
...
router.beforeEach(function (to, from, next) {
  if (to.meta.requiredAuth) {
    if (!_auth.default.checkUser()) {
      console.log(to.path);
      console.log(_auth.default.checkUser());
      router.push('/auth');
    } else {
      next();
    }
...
var app = new _vue.default({
  ...
  methods: {
    menuHandler: function menuHandler(state, msg) {
      this.menuState = state;
      this.menuMsg = msg;
    },
    //Событие обрабатывающее клик по call-action-button
    openSidemenuForm: function openSidemenuForm(msg) {
      console.log(this);
...
// module
exports.push([module.i, "body{margin:0}a{color:var(--blue);text-decoration:none}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_auth_vue__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2eb47790_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_auth_vue__ = __webpack_require__(25);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2eb47790_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_auth_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\vue-comp\\auth.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2eb47790", Component.options)
  } else {
    hotAPI.reload("data-v-2eb47790", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("7b4fc162", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2eb47790\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./auth.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2eb47790\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./auth.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c("div", { staticClass: "auth-page" }, [
    _c("div", { staticClass: "forms" }, [
      ...
      _vm._v(" "),
      _c("form", { class: _vm.authForm, attrs: { method: "post" } }, [
        _c("input", {
          attrs: {
            type: "text",
            name: "user_email",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2eb47790", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_tester_vue__ = __webpack_require__(7);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("1029c1c6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
// module
exports.push([module.i, "", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"tester.vue","sourceRoot":""}]);
