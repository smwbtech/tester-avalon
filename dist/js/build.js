...
var _variables = _interopRequireDefault(__webpack_require__(5));
...
var _sideMenu = _interopRequireDefault(__webpack_require__(7));
...
// module
exports.push([module.i, "\n:root{font-family:Marta;font-size:16px;line-height:1.4\n}\n.question-var{display:flex;width:calc(4.16667vw * 10);max-height:40px;margin-bottom:20px;justify-content:space-between\n}\n.question-var>*{display:block;max-width:calc(4.16667vw * 10);align-self:center\n}\n.question-var input[type=text]{max-width:calc(4.16667vw * 6);border:none;border-bottom:1px solid #092e64\n}\n.question-var img{max-width:20px;cursor:pointer;opacity:.5;transition:opacity .2s ease-in-out\n}\n.question-var img:hover{opacity:1\n}\n.question-var input[type=checkbox]{display:none\n}\nlabel[for=right_var]{cursor:pointer;color:#092e64;opacity:.5;transition:opacity .2s ease-in-out\n}\n.question-var label.active,label[for=right_var]:hover{opacity:1\n}", "", {"version":3,"sources":["D:/xampp/htdocs/tester-avalon/src/css/variables.css","D:/xampp/htdocs/tester-avalon/src/vue-comp/questions/src/vue-comp/questions/multiple.vue"],"names":[],"mappings":";AAAA,MACI,kBAAqB,eACL,eACC;CAYpB;ACiCD,cACA,aAAA,2BACA,gBACA,mBACA,6BACA;CACA;AAEA,gBACA,cAAA,+BACA,iBACA;CACA;AAEA,+BACA,8BAAA,YACA,+BACA;CACA;AAEA,kBACA,eAAA,eACA,WACA,kCAGA;CACA;AAEA,wBACA,SAAA;CACA;AAEA,mCACA,YAAA;CACA;AAEA,qBACA,eAAA,cACA,WACA,kCAGA;CACA;AAMA,sDACA,SAAA;CACA","file":"multiple.vue","sourcesContent":[":root {\r\n    font-family: 'Marta';\r\n    font-size: 16px;\r\n    line-height: 1.4;\r\n    --blue: #092E64;\r\n    --purple: #656695;\r\n    --darkpurple: #313149;\r\n    --marine: #3493A8;\r\n    --yellow: #EFDA7B;\r\n    --green: #9DBE87;\r\n    --red: #c74545;\r\n    --column: calc(100vw / 24);\r\n    --row: calc(100vh / 12);\r\n    --column-mobile: calc(100vw / 12);\r\n    --row-mobile: calc(100vh / 24);\r\n}\r\n","<template lang=\"html\">\r\n\r\n    <div class=\"question-var\">\r\n        <input type=\"text\" name=\"\" value=\"\" placeholder=\"Вариант ответа\" v-model=\"varText\" @input=\"updateInfo\">\r\n        <img @click=\"deleteVar\" src=\"img/cross.svg\" alt=\"\">\r\n        <label @click=\"rightVar\" for=\"right_var\" :class=\"{active: isRight}\">правильный</label>\r\n        <input type=\"checkbox\" name=\"\" value=\"\" id=\"right_var\">\r\n    </div>\r\n\r\n</template>\r\n\r\n<script>\r\nexport default {\r\n\r\n    props: ['text', 'status', 'id'],\r\n\r\n    data() {\r\n        return {\r\n            varText: this.text ? this.text : '',\r\n            placeholderText: this.text,\r\n            isRight: this.status,\r\n            questionId: this.id\r\n        }\r\n    },\r\n\r\n    methods: {\r\n        //Удаление варианта\r\n        deleteVar(e) {\r\n            this.$emit('removeVar', this.id);\r\n        },\r\n\r\n        // Обнавляем текст варианта\r\n        updateInfo() {\r\n            this.$emit('updateVar', this.id, this.varText);\r\n        },\r\n\r\n        // Обнавляем статус правильного ответа варианта\r\n        rightVar() {\r\n            let index = Array.prototype.indexOf.call(this.$el.parentNode.childNodes, this.$el);\r\n            this.$emit('updateRightVar', index);\r\n        }\r\n    }\r\n}\r\n</script>\r\n\r\n<style lang=\"css\">\r\n\r\n@import './../../css/variables.css';\r\n\r\n    .question-var {\r\n        display: flex;\r\n        width: calc(var(--column) * 10);\r\n        max-height: 40px;\r\n        margin-bottom: 20px;\r\n        justify-content: space-between;\r\n    }\r\n\r\n    .question-var > * {\r\n        display: block;\r\n        max-width: calc(var(--column) * 10);\r\n        align-self: center;\r\n    }\r\n\r\n    .question-var input[type=\"text\"] {\r\n        max-width: calc(var(--column) * 6);\r\n        border: none;\r\n        border-bottom: 1px solid var(--blue);\r\n    }\r\n\r\n    .question-var img{\r\n        max-width: 20px;\r\n        cursor: pointer;\r\n        opacity: 0.5;\r\n        -webkit-transition: opacity .2s ease-in-out;\r\n        -o-transition: opacity .2s ease-in-out;\r\n        transition: opacity .2s ease-in-out;\r\n    }\r\n\r\n    .question-var img:hover {\r\n        opacity: 1;\r\n    }\r\n\r\n    .question-var input[type=\"checkbox\"] {\r\n        display: none;\r\n    }\r\n\r\n    label[for=\"right_var\"] {\r\n        cursor: pointer;\r\n        color: var(--blue);\r\n        opacity: .5;\r\n        -webkit-transition: opacity .2s ease-in-out;\r\n        -o-transition: opacity .2s ease-in-out;\r\n        transition: opacity .2s ease-in-out;\r\n    }\r\n\r\n    label[for=\"right_var\"]:hover {\r\n        opacity: 1;\r\n    }\r\n\r\n    .question-var label.active {\r\n        opacity: 1;\r\n    }\r\n\r\n\r\n</style>\r\n"],"sourceRoot":""}]);
...
// module
exports.push([module.i, "\n.content{margin-left:undefined;margin-right:undefined;width:undefined\n}\n.respondents-page{width:100%;padding-top:undefined;display:flex\n}\n.respondents-list{width:100%;display:flex;flex-flow:column;justify-content:center\n}", "", {"version":3,"sources":["D:/xampp/htdocs/tester-avalon/src/vue-comp/src/vue-comp/respondents.vue"],"names":[],"mappings":";AA8CA,SACA,sBAAA,uBACA,eACA;CACA;AAEA,kBACA,WAAA,sBACA,YACA;CACA;AAEA,kBACA,WAAA,aACA,iBACA,sBACA;CACA","file":"respondents.vue","sourcesContent":["<template lang=\"html\">\r\n\r\n    <div class=\"respondents-page\">\r\n\r\n        <side-menu></side-menu>\r\n        <section class=\"content\">\r\n\r\n            <div class=\"loading\" v-if=\"loading\">\r\n\r\n                <loading-indicator></loading-indicator>\r\n\r\n            </div>\r\n\r\n            <div v-else class=\"respondents-list\">\r\n\r\n\r\n\r\n            </div>\r\n\r\n\r\n        </section>\r\n\r\n    </div>\r\n\r\n</template>\r\n\r\n<script>\r\n\r\nimport sideMenu from './side-menu.vue';\r\n\r\nexport default {\r\n\r\n    components: {\r\n        'side-menu': sideMenu\r\n    },\r\n\r\n    data() {\r\n        return {\r\n            loading: false\r\n        }\r\n    }\r\n\r\n}\r\n</script>\r\n\r\n<style lang=\"css\">\r\n\r\n    .content {\r\n        margin-left: calc(var(--column) * 2);\r\n        margin-right: calc(var(--column) * 2);\r\n        width: calc(var(--column) * 16);\r\n    }\r\n\r\n    .respondents-page {\r\n        width: 100%;\r\n        padding-top: calc(var(--row) * 2);\r\n        display: flex;\r\n    }\r\n\r\n    .respondents-list {\r\n        width: 100%;\r\n        display: flex;\r\n        flex-flow: column;\r\n        justify-content: center;\r\n    }\r\n\r\n\r\n</style>\r\n"],"sourceRoot":""}]);
    ...
    [
      ...
      _c("section", { staticClass: "content" }, [
        _vm.loading
          ...
          : _c("div", { staticClass: "respondents-list" })
      ])
    ],
    1
  )
