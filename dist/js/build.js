...
// module
exports.push([module.i, ":root{font-family:Marta;font-size:16px;line-height:1.4}*,:after,:before{box-sizing:border-box}button:focus,input:focus,select:focus,textarea:focus{outline:none}input{font-family:marta}h1,h2,h3,h4,h5,h6{margin:0;padding:0}body{margin:0}a{color:#092e64;text-decoration:none}ul{margin:0;padding:0}.new-test-nav{z-index:101;position:fixed;top:0;left:0;width:100%;padding:20px 0;padding-left:calc(4.16667vw * 6);background-color:hsla(0,0%,100%,.9);box-shadow:0 0 4px 0 rgba(0,0,0,.4)}.new-test-nav li{list-style:none;display:inline-block;opacity:1;min-width:calc(4.16667vw * 3);text-align:center;transition:opacity .2s ease-in-out}.new-test-nav li:hover{opacity:1}.new-test-nav li:last-child{padding-left:40px}.new-test-nav li a{font-weight:700;display:block;border-radius:3px;background-color:#092e64;color:#fff;padding:10px;transition:all .2s ease-in-out}.new-test-nav li a:hover{box-shadow:1px 1px 9px rgba(0,0,0,.4)}@media screen and (max-width:812px){h1,h2,h3,h4,h5,h6,p{text-align:center}}", ""]);
